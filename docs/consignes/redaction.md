...
[
  ...
  {"mot":"religion","etymologie":[{"forme":"religio","langue":"latin","sens":"attention scrupuleuse, scrupule"},{"langue":"latin","alternatives":{"mode":"debattue","formes":[{"forme":"relegere","sens":"reprendre avec soin","elements":[{"forme":"re-","sens":"de nouveau"},{"forme":"legere","sens":"recueillir"}],"selon":["ciceron"]},{"forme":"religare","sens":"attacher","elements":[{"forme":"re-","sens":"en arrière"},{"forme":"ligare","sens":"lier"}],"selon":["lactance"]}]}}],"explication":"La religio est le scrupule qui fait hésiter, celui du juge devant un verdict comme celui du Romain devant les dieux. Le mot ne désignait pas une croyance, mais ce qui retient d'agir.","famille":["religieux","religiosité","irréligion"],"themes":["religion"]},
